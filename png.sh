...
inkscape logo.svg -w 180 -h 180 -b "#242933" --actions="$setViewBox;$setFill #ebedf2" -o png/apple-touch-icon.png
inkscape logo.svg -w 192 -h 192 -b "#242933" --actions="$setViewBox;$setFill #ebedf2" -o png/android-chrome-192x192.png
inkscape logo.svg -w 512 -h 512 -b "#242933" --actions="$setViewBox;$setFill #ebedf2" -o png/android-chrome-512x512.png
